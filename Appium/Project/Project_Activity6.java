...
public class Project_Activity6 {
	 ...
	 @BeforeClass
	  ...
	  @Test(enabled=true)
	  public void Support_PopUpSucessLogin() throws InterruptedException {
...
//		  action.perform();
		...
		//driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).scrollForward()"));
		 driver.findElementByXPath("//android.view.View[contains(@text,'Tooltips and Modals')]").click();
		  //Thread.sleep(3000);
		  //driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).flingToEnd(10)"));
		  Thread.sleep(3000);
		 ...
		 // driver.findElement(MobileBy.id("username")).sendKeys("admin");
		  driver.findElementByXPath("//android.view.View[4]/android.widget.Button[contains(@text,'Sign In')]").click();
		  Thread.sleep(3000);
	  ...
	  @Test(enabled=true)
	  public void Support_PopUpUnSucessLogin() throws InterruptedException {
